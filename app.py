...
def wishMe():
        ...
        if hour>=0 and hour<12:
            speak(" hello, good morning gorgeous! your smile is the best way to start the day ")
        elif hour>=12 and hour<16:
            speak(" have a great afternoon beautiful! remember you are amazing and capable of anything ")
        else:
            speak(" priya is my favourite")
        speak("i am bibble. please tell me how can i help you priya")
...
# Time
        ...
        # Exit
            ...
            speak("Goodbye baby doll! have a nice day")
            break
